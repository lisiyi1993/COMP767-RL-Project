...
num_frames = int(2e5)
target_update = 1000 # try 100, 1000, 10000
batch_size = 512
backprops_freq = 0
PATH = os.path.join("..", "training", f"dqn_freq{target_update}")
...
for i_update in range(num_frames+1):
    ...
    if i_update % 100 == 0:
        ...
        plt.ylabel("Rewards")
        plt.savefig("training_reward.pdf", bbox_inches="tight")
